...
Point3d findLightPosition(const Mat& homography, const Mat& image1, double caster1Height, const Mat& image2, double caster2Height, double tolerance)
{
	Point3d intersect;
...
bool closestPointsOnLines(const Point3d& P1, const Point3d& D1,
	...
	Point3d& intersectionPoint, double tolerance) 
{
	Point3d P12 = P1 - P2;
